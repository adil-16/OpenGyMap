  ...
  return (
    <>
      <div className="shadow-custom-light">
        <div className="flex flex-col lg:flex-row justify-center border-b-custom-gray border-b space-y-4 lg:space-y-0 lg:space-x-20 p-4 ">
          ...
          <div className="text-center lg:text-left">
            ...
            <div className="py-4 text-sm text-custom-black flex flex-col items-center lg:items-start">
        ...
        <div className="flex flex-col lg:flex-row justify-between p-4 space-y-2 lg:space-y-0">
