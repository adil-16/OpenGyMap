...
const DeleteAccountModal = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
      <div className="bg-white rounded-lg p-6 w-full max-w-sm sm:max-w-md lg:max-w-lg relative mx-4">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-lg font-semibold text-custom-black">
            Confirm Delete
          </h2>
        ...
        <div className="flex flex-col items-center">
          ...
          />
          <p className="text-center text-custom-black font-bold text-lg sm:text-xl mb-4">
            Confirm Delete
          </p>
          <p className="text-center text-payment-gray mb-4">
            Are you sure you want to delete the facility "Facility Name"?
          ...
          <div className="flex flex-col sm:flex-row  justify-around w-full space-y-2 sm:space-y-0 sm:space-x-4">
            <button
              className="bg-white border rounded-full text-xs  px-6 py-3 font-medium sm:px-20"
              onClick={onClose}
            >
              Cancel
            </button>
